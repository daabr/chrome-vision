...
func (t *Disable) Do(ctx context.Context) error {
	m, err := devtools.SendAndWait(ctx, "DOMSnapshot.disable", nil)
	if err != nil {
		return err
	}
...
func (t *Disable) Start(ctx context.Context) (chan *devtools.Message, error) {
	return devtools.Send(ctx, "DOMSnapshot.disable", nil)
}
...
func (t *Enable) Do(ctx context.Context) error {
	m, err := devtools.SendAndWait(ctx, "DOMSnapshot.enable", nil)
	if err != nil {
		return err
	}
	return t.ParseResponse(m)
...
func (t *Enable) Start(ctx context.Context) (chan *devtools.Message, error) {
	return devtools.Send(ctx, "DOMSnapshot.enable", nil)
}
...
func (t *GetSnapshot) Do(ctx context.Context) (*GetSnapshotResult, error) {
	...
	m, err := devtools.SendAndWait(ctx, "DOMSnapshot.getSnapshot", b)
	if err != nil {
		return nil, err
	}
	return t.ParseResponse(m)
...
// Start sends the GetSnapshot CDP command to a browser,
// and returns a channel to receive the browser's response.
// Callers should close the returned channel on their own,
// although closing unused channels isn't strictly required.
func (t *GetSnapshot) Start(ctx context.Context) (chan *devtools.Message, error) {
	...
	return devtools.Send(ctx, "DOMSnapshot.getSnapshot", b)
}

// ParseResponse parses the browser's response
// to the GetSnapshot CDP command.
...
func (t *CaptureSnapshot) Do(ctx context.Context) (*CaptureSnapshotResult, error) {
	...
	m, err := devtools.SendAndWait(ctx, "DOMSnapshot.captureSnapshot", b)
	if err != nil {
		return nil, err
	}
	return t.ParseResponse(m)
...
func (t *CaptureSnapshot) Start(ctx context.Context) (chan *devtools.Message, error) {
	...
	return devtools.Send(ctx, "DOMSnapshot.captureSnapshot", b)
}
