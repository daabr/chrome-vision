...
func (t *AddInspectedHeapObject) Do(ctx context.Context) error {
	...
	response, err := devtools.Send(ctx, "HeapProfiler.addInspectedHeapObject", b)
	if err != nil {
		return err
	}
...
func (t *CollectGarbage) Do(ctx context.Context) error {
	response, err := devtools.Send(ctx, "HeapProfiler.collectGarbage", nil)
	if err != nil {
		return err
	}
	if response.Error != nil {
...
func (t *Disable) Do(ctx context.Context) error {
	response, err := devtools.Send(ctx, "HeapProfiler.disable", nil)
	if err != nil {
		return err
	}
	if response.Error != nil {
...
func (t *Enable) Do(ctx context.Context) error {
	response, err := devtools.Send(ctx, "HeapProfiler.enable", nil)
	if err != nil {
		return err
	}
	if response.Error != nil {
...
func (t *GetHeapObjectID) Do(ctx context.Context) (*GetHeapObjectIDResult, error) {
	...
	response, err := devtools.Send(ctx, "HeapProfiler.getHeapObjectId", b)
	if err != nil {
		return nil, err
	}
	if response.Error != nil {
...
func (t *GetObjectByHeapObjectID) Do(ctx context.Context) (*GetObjectByHeapObjectIDResult, error) {
	...
	response, err := devtools.Send(ctx, "HeapProfiler.getObjectByHeapObjectId", b)
	if err != nil {
		return nil, err
	}
	if response.Error != nil {
...
func (t *GetSamplingProfile) Do(ctx context.Context) (*GetSamplingProfileResult, error) {
	response, err := devtools.Send(ctx, "HeapProfiler.getSamplingProfile", nil)
	if err != nil {
		return nil, err
	}
	if response.Error != nil {
...
func (t *StartSampling) Do(ctx context.Context) error {
	...
	response, err := devtools.Send(ctx, "HeapProfiler.startSampling", b)
	if err != nil {
		return err
	}
	if response.Error != nil {
...
func (t *StartTrackingHeapObjects) Do(ctx context.Context) error {
	...
	response, err := devtools.Send(ctx, "HeapProfiler.startTrackingHeapObjects", b)
	if err != nil {
		return err
	}
	if response.Error != nil {
...
func (t *StopSampling) Do(ctx context.Context) (*StopSamplingResult, error) {
	response, err := devtools.Send(ctx, "HeapProfiler.stopSampling", nil)
	if err != nil {
		return nil, err
	}
	if response.Error != nil {
...
func (t *StopTrackingHeapObjects) Do(ctx context.Context) error {
	...
	response, err := devtools.Send(ctx, "HeapProfiler.stopTrackingHeapObjects", b)
	if err != nil {
		return err
	}
	if response.Error != nil {
...
func (t *TakeHeapSnapshot) Do(ctx context.Context) error {
	...
	response, err := devtools.Send(ctx, "HeapProfiler.takeHeapSnapshot", b)
	if err != nil {
		return err
	}
	if response.Error != nil {
