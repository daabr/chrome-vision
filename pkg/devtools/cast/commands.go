...
func (t *Enable) Do(ctx context.Context) error {
	...
	response, err := devtools.Send(ctx, "Cast.enable", b)
	if err != nil {
		return err
	}
...
func (t *Disable) Do(ctx context.Context) error {
	response, err := devtools.Send(ctx, "Cast.disable", nil)
	if err != nil {
		return err
	}
	if response.Error != nil {
...
func (t *SetSinkToUse) Do(ctx context.Context) error {
	...
	response, err := devtools.Send(ctx, "Cast.setSinkToUse", b)
	if err != nil {
		return err
	}
	if response.Error != nil {
...
func (t *StartTabMirroring) Do(ctx context.Context) error {
	...
	response, err := devtools.Send(ctx, "Cast.startTabMirroring", b)
	if err != nil {
		return err
	}
	if response.Error != nil {
...
func (t *StopCasting) Do(ctx context.Context) error {
	...
	response, err := devtools.Send(ctx, "Cast.stopCasting", b)
	if err != nil {
		return err
	}
	if response.Error != nil {
