...
// RequestPaused asynchronous event. Issued when the domain is enabled and the request URL matches the
...
// AuthRequired asynchronous event. Issued when the domain is enabled with handleAuthRequests set to true.
