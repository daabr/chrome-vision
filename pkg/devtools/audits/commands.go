...
func (t *GetEncodedResponse) Do(ctx context.Context) (*GetEncodedResponseResult, error) {
	...
	response, err := devtools.Send(ctx, "Audits.getEncodedResponse", b)
	if err != nil {
		return nil, err
	}
...
func (t *Disable) Do(ctx context.Context) error {
	response, err := devtools.Send(ctx, "Audits.disable", nil)
	if err != nil {
		return err
	}
	if response.Error != nil {
...
func (t *Enable) Do(ctx context.Context) error {
	response, err := devtools.Send(ctx, "Audits.enable", nil)
	if err != nil {
		return err
	}
	if response.Error != nil {
...
func (t *CheckContrast) Do(ctx context.Context) error {
	...
	response, err := devtools.Send(ctx, "Audits.checkContrast", b)
	if err != nil {
		return err
	}
	if response.Error != nil {
