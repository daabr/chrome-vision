...
func (t *Clear) Do(ctx context.Context) error {
	response, err := devtools.Send(ctx, "Log.clear", nil)
	if err != nil {
		return err
	}
...
func (t *Disable) Do(ctx context.Context) error {
	response, err := devtools.Send(ctx, "Log.disable", nil)
	if err != nil {
		return err
	}
	if response.Error != nil {
...
func (t *Enable) Do(ctx context.Context) error {
	response, err := devtools.Send(ctx, "Log.enable", nil)
	if err != nil {
		return err
	}
	if response.Error != nil {
...
func (t *StartViolationsReport) Do(ctx context.Context) error {
	...
	response, err := devtools.Send(ctx, "Log.startViolationsReport", b)
	if err != nil {
		return err
	}
	if response.Error != nil {
...
func (t *StopViolationsReport) Do(ctx context.Context) error {
	response, err := devtools.Send(ctx, "Log.stopViolationsReport", nil)
	if err != nil {
		return err
	}
	if response.Error != nil {
